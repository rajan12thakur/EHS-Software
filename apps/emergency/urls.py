...
urlpatterns = [
    ...
    path("reports/<int:pk>/edit/", views.EmergencyReportUpdateView.as_view(), name="report_update"),
    path("reports/<int:pk>/pdf/", views.EmergencyReportPDFView.as_view(), name="report_pdf"),
